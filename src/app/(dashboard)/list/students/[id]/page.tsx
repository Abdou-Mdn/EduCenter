    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-[70%]">
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-background-200 text-text-200 p-4 rounded-md flex items-center gap-4 w-full md:w-[48%] lg:w-[47%] xl:w-[47%]">
              ...
              <div className="">
                ...
                <span className="text-text-100 text-sm">Grade</span>
              </div>
            </div>
            <div className="bg-background-200 text-text-200 p-4 rounded-md flex items-center gap-4 w-full md:w-[48%] lg:w-[47%] xl:w-[47%]">
              <Image
            ...
            <div className="bg-background-200 text-text-200 p-4 rounded-md flex items-center gap-4 w-full md:w-[48%] lg:w-[47%] xl:w-[47%]">
              ...
              <div className="">
                ...
                <span className="text-text-100 text-sm">Class</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 bg-background-200 p-4 rounded-md h-[800px]">
          <h2 className="text-text-200 font-semibold">Student&apos;s Schedule</h2>
          <ScheduleCalendar />
        </div>
      </div>
      ...
      <div className="w-full xl:w-[30%]">
        ...
        <div className="bg-background-200 p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-fixed-100">
            <Link href="/" className=" p-2 rounded-md bg-class-1">Student&apos;s Lessons</Link>
            <Link href="/" className=" p-2 rounded-md bg-class-2 ">Student&apos;s Teachers</Link>
            <Link href="/" className=" p-2 rounded-md bg-class-3 ">Student&apos;s Exams</Link>
            <Link href="/" className=" p-2 rounded-md bg-class-4 ">Student&apos;s Assignments</Link>
            <Link href="/" className=" p-2 rounded-md bg-class-5 ">Student&apos;s Results</Link>
          </div>
        </div>
